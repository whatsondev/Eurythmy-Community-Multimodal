...
echo -e "${BOLD}🚀 Verifying Mission Bravo (Level 4) Infrastructure...${NC}\n"
...
if [ "$ALL_PASSED" = true ]; then
    REQUIRED_APIS=("aiplatform.googleapis.com" "run.googleapis.com" "compute.googleapis.com" "redis.googleapis.com" "vpcaccess.googleapis.com" "cloudbuild.googleapis.com" "artifactregistry.googleapis.com")
    MISSING_APIS=()
