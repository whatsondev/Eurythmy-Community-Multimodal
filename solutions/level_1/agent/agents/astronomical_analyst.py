...
- The instruction uses {stars_url} and {project_id} placeholders
- At runtime, ADK replaces them with values from state
...
3. Call execute_query with the SQL above (replacing PRIMARY_STAR_FROM_STEP_1 and NEBULA_TYPE_FROM_STEP_1 with actual values)
...
- Start by calling extract_star_features with the star field URL above""",
